...
<body style="background: rgb(146, 138, 151);">
<%--<nav id="site-nav">--%>
...
<div id="site-main">
        ...
        <div class="container">
            <div class="headline-content">
                ...
                <form class="search-form" target="_blank" action="https://www.google.com/search"><input
                        class="search-keyword" type="search" autocomplete="off" autofocus="" name="q"
                        placeholder="Google 搜索"></form>
            </div>
        </div>
    </div>
    <div class="works">
        ...
        <div class="gallery" data-cols="3" data-height="0.8" data-margin="0"
            ...
            <div class="entry work-entry w2"
                ...
                <a href="#">
                    <div class="reveal reveal-in">
                        <div class="entry-image imageBG" data-img="static/img/moon.jpg"
                             style="background-image: url('static/img/moon.jpg'); background-size: cover; background-position: center center;"></div>
                        <div class="info">
                            <div class="content">
                                <div class="title">SeeMoonUp</div>
                                <div class="cat">天上有月亮 地下有六便士</div>
                            </div>
                        </div>
                    </div>
                </a></div>
            <div class="entry work-entry"
                ...
                <a href="https://seemoonup.github.io/">
                    <div class="reveal reveal-in">
                        <div class="entry-image imageBG" data-img="static/img/mineblog.jpeg"
                             style="background-image: url('static/img/mineblog.jpeg'); background-size: cover; background-position: center center;"></div>
                        <div class="info">
                            <div class="content">
    ...
    <footer id="site-footer">
        <div class="container">
            <div class="copy">© <span id="current-year">2018</span>&nbsp;javalemon<br>天上有月亮 地下有六便士</div>
